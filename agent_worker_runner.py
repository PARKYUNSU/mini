...
from agent_hitl_state import pending_approvals
from agent_nodes import _is_execution_failure
...
def execute_graph_turn(
    ...
    *,
    ...
    from agent_config import LLM_RETRY_DELAY_SEC, LLM_RETRY_MAX
    ...
    try:
        ...
        if not stream_user_notified and bridge_job_id is None:
            from agent_telegram import notify_chat_error as _notify2
