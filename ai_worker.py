...
from agent_bridge_queue import claim_next_pending_job, init_bridge_db, reset_processing_stale
from agent_chroma_rag import warmup_chroma_rag
from agent_config import CHECKPOINT_DB_PATH, GROQ_API_KEY, PROJECT_ROOT, get_gemini_api_keys
from agent_cron_worker import start_cron_worker_daemon
from agent_graph import build_graph
from agent_nodes import _run_tool_on_host
from agent_session import get_session, stash_pending_image, with_chat_lock
from agent_tool_rag import sync_tool_chroma_from_disk
from agent_vision import run_vision_analysis
...
def process_one_job(graph, job: dict) -> None:
    from agent_bridge_queue import complete_job, fail_job
