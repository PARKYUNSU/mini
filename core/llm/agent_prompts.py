...
- 여러 문서가 섞여 있으면 사용자 질문에 가장 맞는 문서 하나만 골라 그 내용만 다룹니다.
- 사용자 메시지 말미의 **[출력 템플릿]**은 이모지·HTML <b>…</b> 태그·줄바꿈·번호까지 포함해 한 글자도 바꾸지 말고 그대로 출력한 뒤, 괄호 안 안내만 실제 요약으로 바꿉니다.
...
RAG_OUTPUT_TEMPLATE_STRICT = """[주의사항]
