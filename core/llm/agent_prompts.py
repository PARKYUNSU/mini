...
- 한국어로만, 짧고 읽기 쉽게 답합니다.
- 참고 문서에 나온 내용만 사용하고, 없으면 없다고 말합니다.
- 여러 문서가 섞여 있어도 사용자 질문에 가장 맞는 문서 하나만 골라 그 내용만 다룹니다.
- 마크다운(###, 굵게 등)은 쓰지 말고 평문과 필요 시 짧은 줄바꿈만 씁니다.
- <redacted_thinking> 등 사고 과정·내부 추론 태그나 설명은 절대 출력하지 않습니다."""

DIRECT_ANSWER_RAG_DEPTH_SUFFIX = (
    "\n같은 3가지 항목 형식을 유지하되, 각 항목을 더 구체적으로(방법·실험·수치가 있으면 포함해) 길게 서술합니다."
)
